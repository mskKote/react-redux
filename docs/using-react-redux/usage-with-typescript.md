...
Согласно React-Redux версии v8, React-Redux полностью написан на TypeScript и типизация включены в распространяемый пакет. Вдобавок типизация содержит в себе несколько помощников (helpers) для упрощения написания типобезопасных интерфейсов между Redux контейнером и React компонентами.
